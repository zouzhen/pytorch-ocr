...
if __name__ == '__main__':
    ...
    dataset = baiduDataset("data/vehicle/Image", "data/vehicle/Main/train.txt", params.alphabet, False, (params.imgW, params.imgH))
    val_dataset = baiduDataset("data/vehicle/Image", "data/vehicle/Main/val.txt", params.alphabet, False, (params.imgW, params.imgH))
